...
/**
 * The interval type being considered (in \f$\left[0, \pi\right]\f$ or in
 * \f$\left[-1, 1\right]\f$)
 */
enum BandSpace {
  FREQ, /**< not done the change of variable (i.e. we are in \f$\left[0,
           \pi\right]\f$) */
  CHEBY /**< done the change of variable (i.e. we are in \f$\left[-1,
           1\right]\f$) */
};
 ...
 * @param[in]  direction the direction in which the change of variable is
 * performed
